...
set hlsearch
" Set the commands to save in history default number is 1000.
set history=1000
...
if has('gui_running')
    ...
    " MODIFIED FOR MAC: Uses Menlo (Standard Mac) or CaskaydiaCove (if installed)
    ...
    " <Bar> is the pipe character. <CR> is the enter key.
...
" !python3 % executes the current file with Python (Mac uses python3).
